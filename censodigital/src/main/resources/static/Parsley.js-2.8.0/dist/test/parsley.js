    ...
    */
    this.messages = {
      ...
      , type: {
          ...
          , urlstrict:  "Url con formato inválido."
          , number:     "Solo puede Ingresar Números."
          , digits:     "Solo puede Ingresar Dígitos."
          , dateIso:    "Formato de fecha inválido."
          , alphanum:   "Solo puede Ingresar Números y/o Letras."
          , letras_numeros:   "Solo puede Ingresar Números y/o Letras incluye espacios en blanco."
          , phone:      "Formato de teléfono inválido."
          , ext_cer:    "La extension del archivo no es válida."
          , ext_key:    "La extension del archivo no es válida."
          , clave_valida: "La clave debe ser mínimo 6 y máximo 20 caracteres. Al menos una letra mayúscula. Al menos una letra minúscula. Al menos un dígito, No espacios en blanco, Al menos 1 caracter especial @.-#*"
          , alfanumguiones : "Solo se permiten letras y/o números, guión medio y guión bajo. "
          , letras_numeros_acentos: "Solo puede ingresar Números y/o Letras, incluye espacios en blanco."
          , preguntas: "Solo puede ingresar números y/o letras incluye espacios en blanco y signo de interrogación."
        }
      , notnull:        "Valor no puede ser null."
      , notblank:       "Valor no puede ser vacio."
      , required:       "Este valor es requerido."
      , regexp:         "Valor con formato Inválido."
      , min:            "Este valor debe ser mayor o igual que %s."
      , max:            "Este valor debe ser menor o igual que %s."
      , range:          "Este valor debe estar entre %s y %s."
      , minlength:      "Este Valor de tener %s caracteres o más."
      , maxlength:      "Este Valor de tener %s caracteres o menos."
      , rangelength:    "Este valor debe tener entre %s y %s caracteres."
      , mincheck:       "Debe seleccionar al menos %s de las opciones."
      , maxcheck:       "Debe seleccionar %s opciones o menos."
      , rangecheck:     "Debe seleccionar entre %s y %s opciones."
      , equalto:        "Este valor debe ser igual al anterior."
    },
      ...
      , type: function ( val, type ) {
        ...
        switch ( type ) {
          ...
          case 'ext_key':
             ...
             break;
          case 'clave_valida':
            regExp =/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@*#.])[A-Za-z\d@*#.]{6,20}[^'\s]/;
            break;
          case 'alfanumguiones':
            regExp=/^\w+[\-\_\w]*$/;
            break;
          case 'letras_numeros_acentos':
            regExp=/^([a-zA-ZáéíóúAÉÍÓÚÑñ0-9])+(\s+([a-zA-ZáéíóúAÉÍÓÚÑñ0-9])+)*$/;
            break;
          case 'preguntas':
            regExp=/^(¿)?\w+(\s+\w+)*(\?)?$/;
            break;
